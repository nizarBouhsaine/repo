...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 09 déc. 2022 à 22:40
...
INSERT INTO `books` (`id`, `title`, `picture`, `author`, `genre`, `pubdate`, `edition`, `isbn`, `rating`, `language`, `isDeleted`, `copyAmount`) VALUES
(1, 'The title Book of common sense investing', '/com/example/libraryapp/assets/book1.jpg', 'John C.Bogle', 'Fiction,Crime,Psychological', '2010', 'omnis', 123269512, 5, 'fi', 0, 5),
(2, 'Hamlet', '/com/example/libraryapp/assets/book2.jpg', 'William Shakespear', 'Fiction,Crime,Psychological', '1415', 'repellendus', 123269512, 5, 'nl', 1, 5),
(3, 'Harry Potter and the cursed child', '/com/example/libraryapp/assets/book3.jpg', 'J.K Rowling', 'Fiction,Crime,Psychological', '2017', 'dolor', 123269512, 5, 'uk', 0, 5),
(4, 'The Lord of the Rings', '/com/example/libraryapp/assets/book4.jpg', 'J.R.R Tolkien', 'Fiction,Crime,Psychological', '2003', 'modi', 123269512, 5, 'tg', 1, 5),
(5, '1Q84', '/com/example/libraryapp/assets/book5.jpg', 'Haruki Murakami', 'Fiction,Crime,Psychological', '2011', 'harum', 123269512, 5, 'mn', 1, 5);
